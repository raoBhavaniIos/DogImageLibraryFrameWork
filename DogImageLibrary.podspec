#
#  Be sure to run `pod spec lint DogImageLibrary.podspec' to ensure this is a
...
Pod::Spec.new do |spec|
  ...
  # Or just: spec.author    = "Bhawanisingh Rao"
  # spec.authors            = { "Bhawanisingh Rao" => "rao.bhavani55@gmail.com" }
  # spec.social_media_url   = "https://twitter.com/Bhawanisingh Rao"
